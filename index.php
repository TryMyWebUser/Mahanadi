                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-12 d-center">
                                <div class="header-top-left"><img src="img/icon/call.png" alt="" />Call Us : +11 222 3333</div>
                            </div>
                            <!-- Header Top left End -->
                            <!-- Search Box Start -->
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="header-top-right">
                                    <ul class="header-list-menu f-right">
                                        <!-- Language Start -->
                                        <li>
                                            <a href="#">Language: English <i class="fa fa-angle-down"></i></a>
                                        ...
                                        <!-- Currency Start -->
                                        <li>
                                            <a href="#">Currency: USD <i class="fa fa-angle-down"></i></a>
                                            <ul class="ht-dropdown">
                                                <li><a href="#">USD</a></li>
                                                <li><a href="#">GBP</a></li>
                                                <li><a href="#">EUR</a></li>
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-auto">
                                <div class="cart-box text-end">
                                    <ul>
                                        <li>
                                            <a href="compare.html"><i class="fa fa-cog"></i></a>
                                            <ul class="ht-dropdown">
                    ...
                    <div class="container">
                        <div class="footer-bottom-content">
                            <p class="copy-right-text">
                                &copy; 2023 <strong> Jantrik </strong> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/" target="_blank"><strong>HasThemes</strong></a>
                            </p>
